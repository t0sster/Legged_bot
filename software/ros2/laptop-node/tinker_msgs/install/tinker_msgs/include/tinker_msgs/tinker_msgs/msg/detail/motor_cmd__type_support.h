...
#ifndef TINKER_MSGS__MSG__DETAIL__MOTOR_CMD__TYPE_SUPPORT_H_
#define TINKER_MSGS__MSG__DETAIL__MOTOR_CMD__TYPE_SUPPORT_H_
...
#endif  // TINKER_MSGS__MSG__DETAIL__MOTOR_CMD__TYPE_SUPPORT_H_
