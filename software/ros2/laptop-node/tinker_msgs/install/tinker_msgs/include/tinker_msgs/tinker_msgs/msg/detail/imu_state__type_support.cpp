...
{
  new (message_memory) tinker_msgs::msg::IMUState(_init);
}

void IMUState_fini_function(void * message_memory)
{
  auto typed_message = static_cast<tinker_msgs::msg::IMUState *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember IMUState_message_member_array[6] = {
  {
    ...
    offsetof(tinker_msgs::msg::IMUState, timestamp_state),  // bytes offset in struct
  ...
  },
  {
    ...
    4,  // array size
    false,  // is upper bound
    offsetof(tinker_msgs::msg::IMUState, quaternion),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    3,  // array size
    false,  // is upper bound
    offsetof(tinker_msgs::msg::IMUState, gyroscope),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    3,  // array size
    false,  // is upper bound
    offsetof(tinker_msgs::msg::IMUState, accelerometer),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    3,  // array size
    false,  // is upper bound
    offsetof(tinker_msgs::msg::IMUState, rpy),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(tinker_msgs::msg::IMUState, temperature),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers IMUState_message_members = {
  ...
  6,  // number of fields
  sizeof(tinker_msgs::msg::IMUState),
...
get_message_type_support_handle<tinker_msgs::msg::IMUState>()
{
  return &::tinker_msgs::msg::rosidl_typesupport_introspection_cpp::IMUState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tinker_msgs, msg, IMUState)() {
  return &::tinker_msgs::msg::rosidl_typesupport_introspection_cpp::IMUState_message_type_support_handle;
}
