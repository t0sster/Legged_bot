...
#ifndef TINKER_MSGS__MSG__DETAIL__LOW_STATE__FUNCTIONS_H_
#define TINKER_MSGS__MSG__DETAIL__LOW_STATE__FUNCTIONS_H_
 ...
 * )) before or use
 * tinker_msgs__msg__LowState__create()
 ...
 * calls
 * tinker_msgs__msg__LowState__init().
...
/**
 * It calls
 * tinker_msgs__msg__LowState__fini()
 ...
 * tinker_msgs__msg__LowState__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * tinker_msgs__msg__LowState__Sequence__fini()
 * on the array,
...
#endif  // TINKER_MSGS__MSG__DETAIL__LOW_STATE__FUNCTIONS_H_
