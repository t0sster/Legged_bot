...
#define USE_VR       0 
//��ѡ ���ɰ汾���� MOCO8  �������� ƽ ͬʱimu_att.z 90
#define MCU_BIND1    0 
#define MCU_BIND2    0//���ɰ汾���� Tinymal-B C Wheel  �������� �� GhostV2
#define MCU_BIND3    0//��ɽ8���ɶ�
#define MCU_TINYMAL  0//mini Tinymal  ���ڳ�ǰ ƽ
#define MCU_TINKER   1//��ǰ������


#define MCU_TINYPALE_S1 0//�����ɶȶ���汾 Tinypale
#define MCU_TINYPALE 0//��������  485��챵��
#define USE_IMU_O    0

#define SPI_MESS_TYPE_3BLDC_DIV 1
#define DIV_Q_RESET 0//��������궨
extern int spi_comm_mess_type;//Э��汾
//----leg sensor 
#define RUN_WEBOTS 0
#define RUN_PI     0
